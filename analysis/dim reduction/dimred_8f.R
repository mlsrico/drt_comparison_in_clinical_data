...
comp <- readRDS("analysis/simulation/resdat/ex_sim_data_8f.rds")
#comp <- comp[c(sel),]
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_pcad_data_8f.rds")
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_tsned_data_8f.rds")
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_umapd_data_8f.rds")
...
## All
#saveRDS(n.ex, "analysis/dim reduction/resdat/allres_dimred_8f.rds")
...
saveRDS(all.dat, "analysis/dim reduction/resdat/dimred_data_8f.rds")
