...
set.seed(1)
sel <- sample(x = 1:60, size = 10); sel

comp <- readRDS("analysis/simulation/resdat/ex_sim_data_5f.rds")
#comp <- comp[c(sel),]
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_pcad_data_5f.rds")
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_tsned_data_5f.rds")
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_umapd_data_5f.rds")
...
## All
#saveRDS(n.ex, "analysis/dim reduction/resdat/allres_dimred_5f.rds")
...
saveRDS(all.dat, "analysis/dim reduction/resdat/dimred_data_5f.rds")
