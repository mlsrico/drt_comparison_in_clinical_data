...
comp <- readRDS("analysis/simulation/resdat/ex_sim_data_11f.rds")
#comp <- comp[c(sel),]
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_pcad_data_11f.rds")
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_tsned_data_11f.rds")
...
#saveRDS(n.ex, "analysis/dim reduction/resdat_out/ex_umapd_data_11f.rds")
...
## All
#saveRDS(n.ex, "analysis/dim reduction/resdat/allres_dimred_11f.rds")
...
saveRDS(all.dat, "analysis/dim reduction/resdat/dimred_data_11f.rds")
