...
comp <- readRDS("analysis/dim reduction/resdat/dimred_data_5f.rds")
...
#saveRDS(ndat, "analysis/clustering/resdata_out/dpfit_5f.rds")
...
#saveRDS(ndat, "analysis/clustering/resdata_out/groups_5f.rds")
...
#saveRDS(ndat, "analysis/clustering/resdata_out/hclust_sil_5f.rds")
...
#saveRDS(ndat, "analysis/clustering/resdata_out/hclust_sil_rand_5f.rds")
...
#saveRDS(ndat, "analysis/clustering/resdata_out/hclust_sil_rand_ch_5f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata/hclust_allind_5f.rds")



selincase <- ndat %>% dplyr::select(id, method, sil, rand, calhar, dunni)
#saveRDS(selincase, "analysis/clustering/resdata/hclust_allind_5f_sel.rds")


dir1 <- c("data/replicas/5f/5f")
dir2 <- c(".rds")
