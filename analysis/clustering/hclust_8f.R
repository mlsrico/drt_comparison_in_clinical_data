...
k <- 8 ## DEFINIR DE ANTEMANO

# Data -----

comp <- readRDS("analysis/dim reduction/resdat/dimred_data_8f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata_out/dpfit_8f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata_out/groups_8f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata_out/hclust_sil_8f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata_out/hclust_sil_rand_8f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata_out/hclust_sil_rand_ch_8f.rds")
...
saveRDS(ndat, "analysis/clustering/resdata/hclust_allind_8f.rds")


selincase <- ndat %>% dplyr::select(id, method, sil, rand, calhar, dunni)
#saveRDS(selincase, "analysis/clustering/resdata/hclust_allind_8f_sel.rds")


dir1 <- c("data/replicas/8f/8f")
dir2 <- c(".rds")
